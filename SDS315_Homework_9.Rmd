...
The jitter plot shows that the smaller the opening of the solder gun correlates to a higher number of skips.
...
The jitter plot shows that the thinner the alloy used for soldering correlates to a higher number of skips.
